...
export default function LandingPage() {
  ...
  return (
    <div class="bg-gradient-to-br from-green-900 to-black">
      <div
      ...
      >
        ...
        >
          "Unlock Your Freelance Potential: Connect, Create, Thrive!"
        </p>
        <div class="h-10"></div>
        <p class="max-w-2xl font-serif text-xl text-gray-400 md:text-2xl">
          Imagine being able to spend less time... That is what you can achieve with JOBIFY
        </p>
